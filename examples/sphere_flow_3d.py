...
from vortex.obstacles import sphere
...
def main():
    ...
    # Get obstacle mask
    sphere_mask = sphere(NX, NY, NZ, sphere_radius, loc)
    obstacle_mask = obstacle_mask.at[:, sphere_mask].set(True) # Assign sphere mask to obstacle mask
    ...
    # Sphere is fixed obstacle
    sphere_bc = FullwayBounceBackBC()                                         
    SPHERE_BC_ID = sphere_bc.id
